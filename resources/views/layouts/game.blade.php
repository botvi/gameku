...
<head>
    ...
    {{-- <script>(function(s){s.dataset.zone='11888179',s.src='https://al5sm.com/tag.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))</script> --}}
    {{-- MONETAG --}}
    <meta charset="UTF-8">
