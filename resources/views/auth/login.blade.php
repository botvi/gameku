        ...
        <div id="pwa-install-alert" class="pwa-install-alert">
            <div class="pwa-alert-header">
                ...
                <div class="pwa-alert-title-group">
                    ...
                    <p class="pwa-alert-desc">Pasang game di Home Screen kamu untuk bermain lebih lancar, cepat, dan layar
                        penuh!</p>
                </div>
            </div>
            ...
            <div id="pwa-ios-guide" class="pwa-ios-instructions" style="display: none;">
                ...
                <span>Ketuk tombol <strong>Bagikan (Share)</strong> di Safari lalu pilih <strong>'Tambahkan ke Layar Utama
...
@push('scripts')
    ...
    <script>
        ...
        function handleGoogleLogin(e) {
            ...
            var isWebView = /wv|WebView|Flutter|MobileApp/i.test(ua) || (window.Flutter !== undefined) || (window
            ...
            try {
                popup = window.open('about:blank', 'GoogleLoginPopup', 'width=' + width + ',height=' + height + ',left=' +
                    left + ',top=' + top + ',status=no,resizable=yes,scrollbars=yes');
            } catch (err) {}
