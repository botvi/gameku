    ...
    <div class="vs-badge">
        <div class="vs-player">
            <div class="vs-player-name is-me" id="ready-my-name">
                <?= strtoupper(auth()->user()->nama_jalur ?? auth()->user()->email) ?>
            </div>
        </div>
...
<script>
{
    ...
    function toggleSFXSetting() {
        ...
        if (window.activeMultiplayerArenaGame && window.activeMultiplayerArenaGame.sound) {
            window.activeMultiplayerArenaGame.sound.mute = nextMuted;
        }
    ...
    //  INIT PHASER
    // =====================================================
    window.activeMultiplayerArenaGame = new Phaser.Game({
        type: Phaser.AUTO,
        width: GAME_WIDTH,
        height: GAME_HEIGHT,
